...
include_once('fauxapi_logger.php');
include_once('fauxapi_utils.php');
include_once('fauxapi_auth.php');
include_once('fauxapi_actions.php');
include_once('fauxapi_pfsense_interface.php');
